...
*/
    ...
    var categories = [
      ...
      { name: "Amusement Centers",  key: "arcade",      color: "#3e0775", fa: '<i class="fa-solid fa-gamepad"></i>',             filter: function (f) { return f.properties && f.properties.leisure === "amusement_arcade"; } },
