...
*/
    ...
    var categories = [
      ...
      { name: "Skating Rinks",      key: "skating",     color: "#0da9b8", fa: '<i class="fa-solid fa-person-skating"></i>',      filter: function (f) { return ((f.properties && f.properties.leisure === "ice_rink")|| sporthas(f, "ice_skating"); } },
