...
var categories = [
  ...
  { name: "Carousels",          filter: f => f.properties?.attraction === "carousel",      icon: makeFaIcon('poi-icon carousel',    '<i class="fa-solid fa-horse-head"></i>'),    ring: "#3d7d6d" },
  ...
  { name: "Animal Scooters",    filter: f => f.properties?.attraction === "animal_scooter", icon: makeFaIcon('poi-icon scooter',     '<i class="fa-solid fa-dragon"></i>'), ring: "#f9a825" },
