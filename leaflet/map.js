...
var categories = [
  ...
  { name: "Amusement Centers",  filter: f => f.properties?.leisure === "amusement_arcade", icon: makeFaIcon('poi-icon arcade',      '<i class="fa-solid fa-gamepad"></i>'),       ring: "#6a1b9a" },
  { name: "Trampoline Parks",   filter: f => f.properties?.leisure === "trampoline_park",  icon: makeFaIcon('poi-icon trampoline',  '<i class="fa-solid fa-person-falling"></i>'),ring: "#0277bd" },
  { name: "Escape Rooms",       filter: f => f.properties?.leisure === "escape_game",      icon: makeFaIcon('poi-icon escape',      '<i class="fa-solid fa-key"></i>'),           ring: "#424242" },
  ...
  { name: "Indoor Playgrounds", filter: f => f.properties?.leisure === "indoor_play",      icon: makeFaIcon('poi-icon indoor-play', '<i class="fa-solid fa-child"></i>'),          ring: "#00897b" },
  { name: "Laser Tag",          filter: f => sportHas(f, "laser_tag"),                     icon: makeFaIcon('poi-icon laser',       '<i class="fa-solid fa-bullseye"></i>'),       ring: "#e91e63" },
  { name: "Climbing Parks",     filter: f => sportHas(f, "climbing_adventure"),            icon: makeFaIcon('poi-icon climbing',    '<i class="fa-solid fa-mountain"></i>'),       ring: "#455a64" },
  { name: "Go Karts",           filter: f => sportHas(f, "karting"),                       icon: makeFaIcon('poi-icon karting',     '<i class="fa-solid fa-flag-checkered"></i>'), ring: "#000000" },
