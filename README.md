...
When I started this project, the defined Northern Virginia footprint contained 102 mapped “fun” points of interest (45 nodes and 57 ways). Since then, I’ve grown the dataset to 139 features (85 nodes and 54 ways), a net increase of 37 features—about 36% growth. I added many of the new point features and cleaned up existing area features where needed. I’ve edited 111 of the 139 current features (about 80%).
